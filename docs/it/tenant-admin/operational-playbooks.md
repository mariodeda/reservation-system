...
Questa pagina offre risposte passo-passo a situazioni reali comuni. Usala come
guida pratica di servizio.

## Fermare prenotazioni online per oggi

Usa quando il ristorante non puo piu accettare prenotazioni online per un
servizio.

Passi:

1. Apri azione rapida header.
2. Trova il servizio interessato di oggi.
3. Spegni il servizio.
4. Conferma che appaia fermato.
...
Usa solo se il ristorante puo accettare di nuovo prenotazioni online.
...
6. Salva.
7. Assegna tavolo se opportuno.
8. Ripeti dettagli all'ospite.

Se l'ospite non ha email, assicurati che il telefono sia corretto.
...
1. Tieni la prenotazione visibile.
2. Aggiungi o aggiorna note se disponibile.
3. Controlla sala/giorno per conflitti successivi.
4. Cambia tavolo solo se necessario.
5. Non marcare no-show prima del tempo di tolleranza.
...
1. Apri prenotazione.
2. Marca cancelled invece di eliminare.
3. Conserva note utili.
4. Conferma se lo slot torna disponibile.
5. Non inviare email recensione.
...
1. Conferma connessione internet.
2. Aggiorna pagina.
3. Conferma che sessione staff non sia scaduta.
4. Prova un'altra data.
5. Controlla se disponibilita e stata modificata da poco.
...
2. Confronta nome ospite, orario, data e numero ospiti.
...
1. Marca completed tutte le prenotazioni servite.
2. Marca no-show accuratamente.
3. Conferma che cancellazioni non restino confirmed.
4. Rivedi warning email e note follow-up.
5. Invia richieste recensione per completed quando opportuno.
6. Controlla gruppi grandi e note di domani.
7. Fai sign out sui dispositivi condivisi.
